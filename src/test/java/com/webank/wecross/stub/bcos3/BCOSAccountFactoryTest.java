...
public class BCOSAccountFactoryTest {
    ...
    public void loadPemTest()
        ...
        CryptoKeyPair cryptoKeyPair = bcosAccountFactory.loadPemAccount("accounts/gm_bcos/0x1bad8533b8c81962e2a07ccd4485d7a337eec8b8.pem");
    ...
    public void loadP12Test()
        ...
        CryptoKeyPair cryptoKeyPair = bcosAccountFactory.loadP12Account("accounts/bcos/0x4c9e341a015ce8200060a028ce45dfea8bf33e15.p12", "123456");
    ...
    public void buildAccountTest()
        ...
        assertEquals(bcosAccount0.getCredentials().getAddress(), "0x4c9e341a015ce8200060a028ce45dfea8bf33e15");
