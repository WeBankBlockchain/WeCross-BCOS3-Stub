...
public class BCOS3GMEvmStubFactory extends BCOSBaseStubFactory {
    ...
    public BCOS3GMEvmStubFactory() {
        super(CryptoType.SM_TYPE, "sm2p256v1", BCOS3_GM_EVM_STUB_TYPE);
    }

    public static void main(String[] args) throws Exception {
        System.out.println(
                String.format("This is %s Stub Plugin. Please copy this file to router/plugin/", BCOS3_GM_EVM_STUB_TYPE));
